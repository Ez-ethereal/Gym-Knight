...
export default function ProfilePage() {
  ...
  return (
    <div className="flex min-h-screen bg-sky-900">
      ...
      {selectedWorkout &&
        <Popup type={popupType} index={selectedWorkoutIndex} workoutName={selectedWorkout.name} workoutExercises={selectedWorkout.exercises} editWorkouts={editWorkouts} openStatus={buttonPopup} showPopup={showPopup} close={closePopup} />
      }
    </div>
  )
}
